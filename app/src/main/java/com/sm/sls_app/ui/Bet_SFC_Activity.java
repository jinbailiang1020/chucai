...
import com.sm.sls_app.ui.adapter.MyBetLotterListSFCAdapter;
...
/** 功能：投注页面 版本 */
public class Bet_SFC_Activity extends Activity implements OnClickListener {

	private final static String TAG = "Bet_SFC_Activity";
	/* 头部 */
	...
	public MyBetLotterListSFCAdapter adapter;
	...
	/** 普通投注玩法ID **/
	private final int playType = 7401;
	...
	private void findView() {
		...
		btn_playtype.setText("胜负彩投注单");

		adapter = new MyBetLotterListSFCAdapter(Bet_SFC_Activity.this,
	...
	private void init() {
		...
		if (SFC_TeamArrayAdapter.btnMap != null
				&& SFC_TeamArrayAdapter.btnMap.size() != 0) {
			...
			if (SFC_TeamArrayAdapter.btnMap.size() > 0) {
				List_map.add(SFC_TeamArrayAdapter.btnMap);
			}
			numbers.setList_Map(List_map);

			String num = NumberTools.ChangeSFC(SFC_TeamArrayAdapter.btnMap);
	...
	class listItemClick implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			// 跳转页面并传值
			intent = new Intent(Bet_SFC_Activity.this, Buy_SFC_Activity.class);
			...
			Iterator<Entry<Integer, String>> i = btnMap.entrySet().iterator();
			while (i.hasNext()) {
			...
			Bet_SFC_Activity.this.startActivity(intent);
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.bet_btn_deleteall:
			if (AppTools.list_numbers.size() == 0) {
				MyToast.getToast(Bet_SFC_Activity.this, "请先选择投注内容").show();
				break;
			}
			dialog.show();
		...
		case R.id.bet_tv_guize:
			Intent intent = new Intent(Bet_SFC_Activity.this,
	...
	private void join() {
		...
		intent = new Intent(Bet_SFC_Activity.this, JoinActivity.class);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case AppTools.ERROR_MONEY:
				FileUtils.showMoneyLess(Bet_SFC_Activity.this, totalMoney);
				break;
			/** 尚未登陆 **/
			case AppTools.ERROR_UNLONGIN:
				MyToast.getToast(Bet_SFC_Activity.this, "请先登陆").show();
				intent = new Intent(Bet_SFC_Activity.this, LoginActivity.class);
				intent.putExtra("loginType", "bet");
				Bet_SFC_Activity.this.startActivity(intent);
				break;
			/** 点击付款时 所选注数为 0 **/
			case AppTools.ERROR_TOTAL:
				MyToast.getToast(Bet_SFC_Activity.this, "请至少选择一注").show();
				intent = new Intent(Bet_SFC_Activity.this,
						Buy_SFC_Activity.class);
				intent.putExtra("loginType", "bet");
				Bet_SFC_Activity.this.startActivity(intent);
				break;
			case -500:
				MyToast.getToast(Bet_SFC_Activity.this, "连接超时").show();
				break;
			default:
				Toast.makeText(Bet_SFC_Activity.this, "网络异常，购买失败。请重新点击付款购买。",
