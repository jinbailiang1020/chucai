...
import com.sm.sls_app.ui.JoinBetLottery.MyAsynTask;
import com.sm.sls_app.ui.JoinBetLottery.MyHandler;
import com.sm.sls_app.ui.JoinBetLottery.MyItemCLickListener;
...
/**
 * @author 作者 : hxj
 * @version 创建时间：2015-12-14 下午4:37:54 类说明
 */
public class ReplaceBetLottery implements OnScrollListener {
	private View view;
	...
	public ReplaceBetLottery(Context context, View v) {
		this.view = v;
	...
	class MyAsynTask extends AsyncTask<Void, Integer, String> {
		...
		protected String doInBackground(Void... params) {
			...
			info = RspBodyBaseBean.changeMyLotteryInfo_Info(AppTools.lotteryIds
					+ ",72,73", pageIndex, pageSize, sort, isPurchasing, 4);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				all_listView.setOnScrollListener(ReplaceBetLottery.this);
				if (getTotalCount() < 30)
	...
	class MyItemCLickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View view, int position,
			...
			Log.i("replace", "是否合买=== " + scheme.getIsPurchasing());
