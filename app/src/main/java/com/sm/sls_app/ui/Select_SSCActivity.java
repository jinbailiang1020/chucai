...
public class Select_SSCActivity extends Activity implements OnClickListener,
        SensorEventListener {
    ...
    /**
     * 2803 28 复式 2804 28 猜大小 2805 28 五星单复式通选 2806 28 二星组选 2811 28 三星组3 2812 28
     * 三星组6 2813 28 三星直选组合复式 2816 三星组三胆拖 2817三星组六胆拖
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findView();
        init();
        if (NetWork.isConnect(Select_SSCActivity.this) == true) {
            if (AppTools.lottery != null) {
                mAsynTask1 = new MyAsynTask1();
                mAsynTask1.execute();
            }
        } else {
            Toast.makeText(Select_SSCActivity.this, "网络连接异常，获得数据失败！",
    ...
    class MyAsynTask1 extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            imei = RspBodyBaseBean.getIMEI(Select_SSCActivity.this);
    ...
    private void findView() {
        ...
        mAdapterOne = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
        mAdapterTwo = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
        mAdapterThree = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
        mAdapterFour = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
        mAdapterFive = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);

        mAdapterSix = new GridView11X5Adapter(Select_SSCActivity.this, dxds, false);
        mAdapterSeven = new GridView11X5Adapter(Select_SSCActivity.this, dxds,
                false);
        mAdapterDan = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
        mAdapterTuo = new GridView11X5Adapter(Select_SSCActivity.this, numbers,
                false, false);
    ...
    private void init() {
        ...
        int[] playtype_array = {2803, 2803, 2806, 2803, 2811, 2812, 2803, 2805,
                2804};
        for (Integer i : set) {
    ...
    class MyItemClickListener_1 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (mAdapterOne.getOneSet().contains(str)) {
                ...
                tv.setTextColor(Select_SSCActivity.this.getResources().getColor(
                        R.color.red));
            } else {
            ...
            if (mAdapterDan.getOneSet().contains(str)) {
                ...
                if (itemIndex == 0) {
                    if (mAdapterDan.getOneSetSize() >= 1) {
                        MyToast.getToast(Select_SSCActivity.this, "胆码最多只能选" + 1 + "个")
                                .show();
                        return;
                    }
                } else if (itemIndex == 1) {
                    if (mAdapterDan.getOneSetSize() > 1) {
                        MyToast.getToast(Select_SSCActivity.this, "胆码最多只能选" + 2 + "个")
                                .show();
                        return;
                    }
                }
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (mAdapterTuo.getOneSet().contains(str)) {
                ...
                if (mAdapterTuo.getOneSetSize() >= 9) {
                    MyToast.getToast(Select_SSCActivity.this, "拖码最多只能选" + 9 + "个").show();
                    return;
                }
                mAdapterDan.removeOne(str);
            ...
            case R.id.iv_up_down:
                ...
                popUtil.setOnSelectedListener(new PopupWindowUtil.OnSelectedListener() {
                    ...
                    public void getIndex(int parentIndex, int itemIndex) {
                        if (parentIndex == 0 && itemIndex == 6) {
                            return;
                        }
                        if (itemIndex != Select_SSCActivity.this.itemIndex
                                || parentIndex != Select_SSCActivity.this.parentIndex) {
                            Select_SSCActivity.this.parentIndex = parentIndex;
                            Select_SSCActivity.this.itemIndex = itemIndex;
                            initSelectAll();
                            changePlayType();
     ...
     */
    public void getItem() {
        Intent intent = Select_SSCActivity.this.getIntent();
    /* 幸运选号 回到选号页面时候 */
        ...
        if (null != bundle) {
            ...
            // 胆拖的话
            if (playType == 2816 || playType == 2817) {
                parentIndex = 1;
                if (playType == 2816) {
    ...
    private void showGridView() {
        ...
        vibrator = VibratorView.getVibrator(Select_SSCActivity.this);
        if (parentIndex == 0) {
            switch (itemIndex) {
                case 0:
    ...
    private void playExplain() {
        Intent intent = new Intent(Select_SSCActivity.this, PlayDescription.class);
        Select_SSCActivity.this.startActivity(intent);
    }
     ...
     * 机选 按钮点击
     */
    public void selectRandom_All() {
        switch (itemIndex) {
            case 0:
                mAdapterOne.setOneSet(numberList);
                vibrator();
                break;
            case 1:
                mAdapterOne.setOneSet(numberList);
                mAdapterTwo.setOneSet(numberList);
                vibrator();
                break;
            case 3:
                mAdapterOne.setOneSet(numberList);
                mAdapterTwo.setOneSet(numberList);
                mAdapterThree.setOneSet(numberList);
                vibrator();
                break;
            case 6:
      /* 五星通选摇一摇 机选一组 */
                ...
                mAdapterTwo.setOneSet(numberList);
                mAdapterThree.setOneSet(numberList);
                mAdapterFour.setOneSet(numberList);
                mAdapterFive.setOneSet(numberList);
                vibrator();
                break;
    /* 大小单双摇一摇功能 */
            // case 9:
    ...
    private void submitNumber() {
        if (AppTools.totalCount == 0) {
            MyToast.getToast(Select_SSCActivity.this, "请至少选择一注").show();
        } else if (AppTools.totalCount > 10000) {
            MyToast.getToast(Select_SSCActivity.this, "单注金额不能超过20000").show();
        } else {
            Intent intent = new Intent(Select_SSCActivity.this, Bet_SSCActivity.class);
                ...
                dialog
                        .setDialogResultListener(new ConfirmDialog.DialogResultListener() {
                            ...
                            public void getResult(int resultCode) {
                                ...
                                if (1 == resultCode) {// 确定
                                    clear();
                                    Intent intent = new Intent(Select_SSCActivity.this,
                                            Bet_SSCActivity.class);
                                    Bundle bundle = new Bundle();
                                    bundle.putInt("playType", playType);
    ...
    class MyAsynTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... params) {
            return AppTools.getDate(playID + "", Select_SSCActivity.this);
        }
