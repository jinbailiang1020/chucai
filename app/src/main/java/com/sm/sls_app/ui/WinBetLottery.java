...
public class WinBetLottery implements OnScrollListener {
	private View view;
	...
	public WinBetLottery(Context context, View v) {
		this.view = v;
	...
	class MyAsynTask extends AsyncTask<Void, Integer, String> {
		...
		protected String doInBackground(Void... params) {
			...
			info = RspBodyBaseBean.changeMyLotteryInfo_Info(AppTools.lotteryIds
					+ ",72,73", pageIndex, pageSize, sort, isPurchasing, 3);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				all_listView.setOnScrollListener(WinBetLottery.this);
				if (getTotalCount() < 30)
	...
	class MyItemCLickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View view, int position,
			...
			Log.i("win", "是否合买=== " + scheme.getIsPurchasing());
