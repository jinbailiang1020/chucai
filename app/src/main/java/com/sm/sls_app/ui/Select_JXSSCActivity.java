...
public class Select_JXSSCActivity extends Activity implements OnClickListener,
    SensorEventListener {
  private final static String TAG = "Select_JXSSCActivity";
  ...
  /**
   * 6103 61 复式 6104 61 猜大小 6105 61 五星单复式通选 6106 61 二星组选 6111 61 三星组3 6112 61
   * 三星组6 6113 61 三星直选组合复式 6114 三星组三胆拖 6119三星组六胆拖
   */
  private int playType = 6103;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findView();
    init();
    if (NetWork.isConnect(Select_JXSSCActivity.this) == true) {
      if (AppTools.lottery != null) {
        mAsynTask1 = new MyAsynTask1();
        mAsynTask1.execute();
      }
    } else {
      Toast.makeText(Select_JXSSCActivity.this, "网络连接异常，获得数据失败！",
  ...
  class MyAsynTask1 extends AsyncTask<Void, Integer, String> {
    ...
    protected String doInBackground(Void... params) {
      ...
      imei = RspBodyBaseBean.getIMEI(Select_JXSSCActivity.this);
  ...
  private void findView() {
    ...
    mAdapterOne = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
    mAdapterTwo = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
    mAdapterThree = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
    mAdapterFour = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
    mAdapterFive = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);

    mAdapterSix = new GridView11X5Adapter(Select_JXSSCActivity.this, dxds,
        false);
    mAdapterSeven = new GridView11X5Adapter(Select_JXSSCActivity.this, dxds,
        false);
    mAdapterDan = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
    mAdapterTuo = new GridView11X5Adapter(Select_JXSSCActivity.this, numbers,
        false, false);
  ...
  private void init() {
    ...
    int[] playtype_array = { 6103, 6103, 6106, 6103, 6111, 6112, 6103, 6105,
        6104 };
    for (Integer i : set) {
  ...
  class MyItemClickListener_1 implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
      ...
      if (mAdapterOne.getOneSet().contains(str)) {
        ...
        tv.setTextColor(Select_JXSSCActivity.this.getResources().getColor(
            R.color.red));
      } else {
      ...
      if (mAdapterDan.getOneSet().contains(str)) {
        ...
        if (itemIndex == 0) {
          if (mAdapterDan.getOneSetSize() >= 1) {
            MyToast.getToast(Select_JXSSCActivity.this, "胆码最多只能选" + 1 + "个")
                .show();
            return;
          }
        } else if (itemIndex == 1) {
          if (mAdapterDan.getOneSetSize() > 1) {
            MyToast.getToast(Select_JXSSCActivity.this, "胆码最多只能选" + 2 + "个")
                .show();
            return;
          }
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
      ...
      if (mAdapterTuo.getOneSet().contains(str)) {
        ...
        if (mAdapterTuo.getOneSetSize() >= 9) {
          MyToast.getToast(Select_JXSSCActivity.this, "拖码最多只能选" + 9 + "个")
              .show();
          return;
        }
        mAdapterDan.removeOne(str);
    ...
    case R.id.iv_up_down:
      ...
      popUtil.setOnSelectedListener(new PopupWindowUtil.OnSelectedListener() {
        ...
        public void getIndex(int parentIndex, int itemIndex) {
          ...
          if (itemIndex != Select_JXSSCActivity.this.itemIndex
              || parentIndex != Select_JXSSCActivity.this.parentIndex) {
            Select_JXSSCActivity.this.parentIndex = parentIndex;
            Select_JXSSCActivity.this.itemIndex = itemIndex;
            initSelectAll();
            changePlayType();
  ...
  public void getItem() {
    Intent intent = Select_JXSSCActivity.this.getIntent();
    /* 幸运选号 回到选号页面时候 */
    ...
    if (null != bundle) {
      ...
      // 胆拖的话
      if (playType == 6114 || playType == 6119) {
        parentIndex = 1;
        if (playType == 6114) {
  ...
  private void showGridView() {
    ...
    vibrator = VibratorView.getVibrator(Select_JXSSCActivity.this);
    if (parentIndex == 0) {
      switch (itemIndex) {
      case 0:
  ...
  private void playExplain() {
    Intent intent = new Intent(Select_JXSSCActivity.this, PlayDescription.class);
    Select_JXSSCActivity.this.startActivity(intent);
  }
  ...
  private void submitNumber() {
    if (AppTools.totalCount == 0) {
      MyToast.getToast(Select_JXSSCActivity.this, "请至少选择一注").show();
    } else if (AppTools.totalCount > 10000) {
      MyToast.getToast(Select_JXSSCActivity.this, "单注金额不能超过20000").show();
    } else {
      Intent intent = new Intent(Select_JXSSCActivity.this,
          Bet_JXSSCActivity.class);
            ...
            .setDialogResultListener(new ConfirmDialog.DialogResultListener() {
              ...
              public void getResult(int resultCode) {
                ...
                if (1 == resultCode) {// 确定
                  ...
                  Select_JXSSCActivity.this.startActivity(intent);
                  Select_JXSSCActivity.this.finish();
                }
              }
            });
      } else {
  ...
  class MyAsynTask extends AsyncTask<Integer, Integer, String> {
    ...
    protected String doInBackground(Integer... params) {
      return AppTools.getDate(playID + "", Select_JXSSCActivity.this);
    }
