...
import com.sm.sls_app.ui.adapter.MyBetLotteryXJSSCAdapter;
 ...
 * @author huang 新疆时时彩
 */
public class Bet_XJSSCActivity extends Activity implements OnClickListener,
    Refresh {
  ...
  public MyBetLotteryXJSSCAdapter adapter;
  ...
  private void findView() {
    ...
    btn_playtype.setText("新疆时时彩投注单");

    adapter = new MyBetLotteryXJSSCAdapter(Bet_XJSSCActivity.this,
        AppTools.list_numbers);
    zAdapter = new ZhuiqiAdapter(Bet_XJSSCActivity.this,
  ...
  private void init() {
    ...
    if (null != bundle) {
      ...
      if (type == 9) {
        ...
        // 胆拖号码
      } else if (playType == 6614 || playType == 6619) {
  ...
  class listItemClick implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position,
      ...
      Bet_XJSSCActivity.this.startActivity(intent);
    }
  }
  ...
  public void onClick(View v) {
    ...
    case R.id.bet_tv_guize:
      Intent intent = new Intent(Bet_XJSSCActivity.this, PlayDescription.class);
  ...
  private void join() {
    ...
    intent = new Intent(Bet_XJSSCActivity.this, JoinActivity.class);
    ...
    protected String doInBackground(Void... params) {
      ...
      if (AppTools.list_numbers.size() > 0) {
        ...
        if (AppTools.user != null) {
          ...
          // }
          // else{
          info = RspBodyBaseBean.changeBet_info_ssc("66", AppTools.lottery
          ...
          Log.i("x", "Bet_XJActivity SSC--info" + info);
  ...
  class MyHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      case AppTools.ERROR_MONEY:
        Toast.makeText(Bet_XJSSCActivity.this, "余额不足", Toast.LENGTH_SHORT)
            .show();
        intent = new Intent(Bet_XJSSCActivity.this, RechargeActivity.class);
        intent.putExtra("money", totalMoney);
        Bet_XJSSCActivity.this.startActivity(intent);
        break;
      /** 尚未登陆 **/
      case AppTools.ERROR_UNLONGIN:
        MyToast.getToast(Bet_XJSSCActivity.this, "请先登陆").show();
        intent = new Intent(Bet_XJSSCActivity.this, LoginActivity.class);
        intent.putExtra("loginType", "bet");
        Bet_XJSSCActivity.this.startActivity(intent);
        break;
      /** 点击付款时 所选注数为 0 **/
      case AppTools.ERROR_TOTAL:
        MyToast.getToast(Bet_XJSSCActivity.this, "请至少选择一注").show();
        intent = new Intent(Bet_XJSSCActivity.this, Select_XJSSCActivity.class);
        intent.putExtra("loginType", "bet");
        Bet_XJSSCActivity.this.startActivity(intent);
        break;
      case -500:
        MyToast.getToast(Bet_XJSSCActivity.this, "连接超时").show();
        break;
      default:
        Toast.makeText(Bet_XJSSCActivity.this, "网络异常，购买失败。请重新点击付款购买。",
