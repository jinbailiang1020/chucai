...
public class ExpandAdapterJCZQPassMore extends BaseExpandableListAdapter
	...
	public static HashMap<Integer, HashMap<Integer, ArrayList<String>>> map_hashMap_hhtz = new HashMap<Integer, HashMap<Integer, ArrayList<String>>>();
	...
	// holder.ll_btn_0.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_1.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_2.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_3.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_4.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_5.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_6.setBackgroundResource(R.drawable.jc_btn);
	// holder.ll_btn_7.setBackgroundResource(R.drawable.jc_btn);
	//
	// holder.tv_0.setTextColor(Color.BLACK);
	// holder.tv_0_1.setTextColor(Color.BLACK);
	// holder.tv_1.setTextColor(Color.BLACK);
	// holder.tv_1_1.setTextColor(Color.BLACK);
	// holder.tv_2.setTextColor(Color.BLACK);
	// holder.tv_2_1.setTextColor(Color.BLACK);
	// holder.tv_3.setTextColor(Color.BLACK);
	// holder.tv_3_1.setTextColor(Color.BLACK);
	// holder.tv_4.setTextColor(Color.BLACK);
	// holder.tv_4_1.setTextColor(Color.BLACK);
	// holder.tv_5.setTextColor(Color.BLACK);
	// holder.tv_5_1.setTextColor(Color.BLACK);
	// holder.tv_6.setTextColor(Color.BLACK);
	// holder.tv_6_1.setTextColor(Color.BLACK);
	// holder.tv_7.setTextColor(Color.BLACK);
	// holder.tv_7_1.setTextColor(Color.BLACK);
	// }
