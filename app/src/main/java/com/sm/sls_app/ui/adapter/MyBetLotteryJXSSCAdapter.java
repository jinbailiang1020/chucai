...
import com.sm.sls_app.ui.Bet_JXSSCActivity;
 ...
 */
public class MyBetLotteryJXSSCAdapter extends BaseAdapter {

	// 上下文本
	private Context context;
	// 装彩票的集合
	private List<SelectedNumbers> listSchemes;
	private Bet_JXSSCActivity betActivity;

	/** 构造方法 实现初始化 */
	public MyBetLotteryJXSSCAdapter(Context context,
			List<SelectedNumbers> listSchemes) {
		this.context = context;
		this.listSchemes = listSchemes;
		betActivity = (Bet_JXSSCActivity) context;
	}
