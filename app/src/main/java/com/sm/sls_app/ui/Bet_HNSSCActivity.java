...
import com.sm.sls_app.ui.adapter.MyBetLotteryHNSSCAdapter;
...
/** 功能：投注页面 版本 */
public class Bet_HNSSCActivity extends Activity implements OnClickListener,
		Refresh {
	...
	public MyBetLotteryHNSSCAdapter adapter;
	...
	private void findView() {
		...
		btn_playtype.setText("河内时时彩投注单");

		adapter = new MyBetLotteryHNSSCAdapter(Bet_HNSSCActivity.this,
				AppTools.list_numbers);
		zAdapter = new ZhuiqiAdapter(Bet_HNSSCActivity.this,
	...
	private void init() {
		...
		if (null != bundle) {
			...
			if (type == 9) {
				...
				// 胆拖号码
			} else if (playType == 9216 || playType == 9217) {
	...
	class listItemClick implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			// 跳转页面并传值
			intent = new Intent(Bet_HNSSCActivity.this,
			...
			// 胆拖的话
			if (num.getPlayType() == 9216 || num.getPlayType() == 9217) {
			...
			Bet_HNSSCActivity.this.startActivity(intent);
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.bet_tv_guize:
			Intent intent = new Intent(Bet_HNSSCActivity.this,
	...
	private void join() {
		...
		intent = new Intent(Bet_HNSSCActivity.this, JoinActivity.class);
	...
	private void btn_handClick() {
		...
		intent = new Intent(Bet_HNSSCActivity.this, Select_HNSSCActivity.class);
		Bundle bundle = new Bundle();
		...
		protected String doInBackground(Void... params) {
			...
			if (AppTools.list_numbers.size() > 0) {
				...
				if (AppTools.user != null) {
					...
					// }
					// else{
					info = RspBodyBaseBean.changeBet_info_ssc("92",
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case AppTools.ERROR_MONEY:
				Toast.makeText(Bet_HNSSCActivity.this, "余额不足",
			...
			case AppTools.ERROR_UNLONGIN:
				MyToast.getToast(Bet_HNSSCActivity.this, "请先登陆").show();
				intent = new Intent(Bet_HNSSCActivity.this, LoginActivity.class);
				intent.putExtra("loginType", "bet");
				Bet_HNSSCActivity.this.startActivity(intent);
				break;
			/** 点击付款时 所选注数为 0 **/
			case AppTools.ERROR_TOTAL:
				MyToast.getToast(Bet_HNSSCActivity.this, "请至少选择一注").show();
				intent = new Intent(Bet_HNSSCActivity.this,
						Select_HNSSCActivity.class);
				intent.putExtra("loginType", "bet");
				Bet_HNSSCActivity.this.startActivity(intent);
				break;
			case -500:
				MyToast.getToast(Bet_HNSSCActivity.this, "连接超时").show();
				break;
			default:
				Toast.makeText(Bet_HNSSCActivity.this, "网络异常，购买失败。请重新点击付款购买。",
						Toast.LENGTH_SHORT).show();
				break;
			}
