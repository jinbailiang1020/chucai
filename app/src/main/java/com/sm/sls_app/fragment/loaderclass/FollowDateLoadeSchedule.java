...
public class FollowDateLoadeSchedule implements OnScrollListener {
	private static final String TAG = "FollowDateLoadeSchedule";
	private View view;
	...
	public FollowDateLoadeSchedule(String lotteryId, Context context, View v,
		...
		protected String doInBackground(Void... params) {
			...
			try {
				String result = HttpUtils.doPost(AppTools.names, values,
						AppTools.path);
				Log.i("x", "Follow---result---" + result);
				/**
				 * { "error": "0", "msg": "", "serverTime":
				 * "2016-01-27 15:57:59", " schemeList": [ { "Id": "295",
				 * "lotteryID": "92", "lotteryName": "河内时时彩", "multiple": "1",
				 * "initiateUserID": "174", "initiateName": "广发**", "money":
				 * "3360.00", "shareMoney": "1.00", "share": "3360",
				 * "surplusShare": "15", "assureShare": "1860", "assureMoney":
				 * "1860.00", "schemeBonusScale": "0.002", "secrecyLevel": "0",
				 * "quashStatus": "0", "level": "4", "winMoneyNoWithTax":
				 * "0.00", "schedule": "99.55", "schemeIsOpened": "0", "title":
				 * "(无标题)", "description": "", "AtTopStatus": "0", "CountNotes":
				 * "1680", "SerialNumber": "1", "RecordCount": "72" }] }
				 */
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			default:
				...
				MyToast.getToast(context, "数据加载失败").show();
				followListView.setMode(Mode.PULL_FROM_START);
				break;
			}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		// followListView.setFirstItemIndex(firstVisibleItem);
	}
