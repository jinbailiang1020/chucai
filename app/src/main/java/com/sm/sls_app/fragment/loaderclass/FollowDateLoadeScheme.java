...
import com.sm.sls_app.fragment.loaderclass.FollowDateLoadeRecord.MyAsynTask;
import com.sm.sls_app.fragment.loaderclass.FollowDateLoadeRecord.MyHandler;
import com.sm.sls_app.fragment.loaderclass.FollowDateLoadeRecord.listItemClicl;
...
public class FollowDateLoadeScheme implements OnScrollListener {
	private View view;
	...
	public FollowDateLoadeScheme(String lotteryId, Context context, View v,
				...
				if (null != result) {
					...
					if ("0".equals(object.opt("error"))) {
						...
						for (int i = 0; i < array.length(); i++) {
							...
							/**
							 * {"schemeIsOpened":"0","lotteryID":"70",
							 * "schemeBonusScale"
							 * :"0.009","quashStatus":"0","surplusShare"
							 * :"699","secrecyLevel"
							 * :"0","initiateName":"宝马***","initiateUserID"
							 * :"86",
							 * "SerialNumber":"1","share":"1044","schedule"
							 * :"33.05"
							 * ,"title":"(无标题)","level":"3","CountNotes":
							 * "522","shareMoney"
							 * :"1.00","RecordCount":"3","assureMoney"
							 * :"699.00","assureShare"
							 * :"699","description":"","money"
							 * :"1044.00","Id":"101121"
							 * ,"multiple":"1","lotteryName"
							 * :"江西11选5","winMoneyNoWithTax":"0.00"}
							 */
